...
#read from csv
#with open('Dataset/colon.csv') as csvfile:
#	dataset=csv.DictReader(csvfile)
file=csv.reader(open('Dataset/german.csv','r'))
data=[]
for row in file:
	data.append(row)
...
#dataset = sio.loadmat("Dataset/DLBCL.mat")
#MA_data = dataset['data']
#MA_label = dataset['ylab']
...
with tf.device("/gpu:0"):
	rbm1 = RBM(n_hidden=n_hidden1, n_visible=n_feature, alpha=0.0001, datatype="binary")
	...
	with open('FeatureRank.csv', 'w') as csvfile:
